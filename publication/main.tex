...
\title[short Title]{Quick Permutation Test for rapid filtering of n-gram data}
\author[Sample \textit{et~al}.]{Piotr Sobczyk\,$^{\text{\sfb 1,*}}$, Pawe\l{} Mackiewicz$^{\text{\sfb 2}}$ and Micha\l{} Burdukiewicz$^{\text{\sfb 2,*}}$}
\address{$^{\text{\sf 1}}$Wroc\l{}aw University of Technology, Department of Mathematics and 
$^{\text{\sf 1}}$University of Wroc\l{}aw, Department of Genomics}
